import os
import time
from brats_segmentation.dataloader import get_patient_data, get_dataloader
...
def test_dataloader():
    base_path = "/work/projects/ai_imaging_class/dataset"  # Adjust to your dataset location
    ...
    batch_size = 2
    dataloader = get_dataloader(patient_dirs, batch_size=batch_size, shuffle=False, num_workers=0)
    log(f"Initialized DataLoader with batch_size={batch_size}, shuffle=False, num_workers=0")
